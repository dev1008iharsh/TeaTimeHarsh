...
class ImageZoomViewer: NSObject, UIScrollViewDelegate, UIGestureRecognizerDelegate {
    ...
    private func setupGestures() {
        ...
        customRotationGesture = rotationGesture
    }
    ...
    @objc private func handleSave() {
        ToastManager.shared.show(message: "Saving image....", type: .success)
    ...
    @objc private func handleShare() {
        ToastManager.shared.show(message: "Sharing image....", type: .success)
        HapticHelper.light()
