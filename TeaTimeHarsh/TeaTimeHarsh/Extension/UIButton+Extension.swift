...
extension UIButton {
    func applySingleSelectionMenu(title: String, items: [String], selectedItem: String?, onSelect: @escaping (String) -> Void) {
        menu = SingleSelectionMenuBuilder.makeMenu(title: title, items: items, selectedItem: selectedItem) { selected in
    ...
    func animateAndConfigure(title: String, systemImageName: String, backgroundColor: UIColor) {
        // Step 1: Zoom up
